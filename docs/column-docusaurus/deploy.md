...
<Image src={require('./img/deploy/2022-01-18.jpg').default} />
...
<Image src={require('./img/deploy/2022-01-21.jpg').default} height={360} />

- 按照图片中的地址访问宝塔面板时，默认的 `8888` 的端口号需要在云服务器的 **防火墙** 中添加 **安全组端口规则** 之后（各服务器的添加规则可能不一样），才能正常访问，如图:

<Image src={require('./img/deploy/2022-01-21-anquanzu.jpg').default} />
...
<Image src={require('./img/deploy/2022-01-21-ssh-error.jpg').default} />
