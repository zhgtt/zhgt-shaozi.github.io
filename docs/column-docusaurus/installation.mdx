...
![Example Image](/img/docs/installaction/2021-11-03.jpeg)
...
| `type`                 | <code>'doc' \| 'search' \| 'localeDropdown' \| 'docsVersion' \| 'docsVersionDropdown'</code> |          | ✅   | 定义菜单的类型，除了普通的菜单类型外，Docusaurus 还提供了其他几种不同的类型，具体内容可查看下方 _[NavbarItem.type 类型介绍](#themeConfig-navbar-type)_ |
...
- **docusaurus.config.js** 中有一些配置项被很多地方用到，比如 标题，副标题 等，因此 Docusaurus 提供了一个 **React Hooks 函数**，用来获取全局的配置项内容，如下：
