...
<img src={require('./img/2021-09-13-vs-code/auto-close-tag.jpg').default} alt="Example Image" />
...
<img src={require('./img/2021-09-13-vs-code/css-intellisense.jpg').default} alt="Example Image" />
...
<img src={require('./img/2021-09-13-vs-code/open-in-browser.jpg').default} alt="Example Image" />
...
<img src={require('./img/2021-09-13-vs-code/live-server.jpg').default} alt="Example Image" />
...
在 markdown 的标题中单独 ✍🏻 'Jest' 时，不管是什么格式，在个人本地项目中都会产生与 Jest 相关的报错信息；
