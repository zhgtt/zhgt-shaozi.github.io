...
export const Lottie_404_Error_3 = require('@site/static/json/lotties/itg-404.error-3.json');
export const Lottie_404_Error_4 = require('@site/static/json/lotties/itg-404.error-4.json');
export const Lottie_404_Error_5 = require('@site/static/json/lotties/itg-404.error-5.json');
...
export const Lottie_Dashboard_3 = require('@site/static/json/lotties/itg-dashboard-3.json');
export const Lottie_Dashboard_4 = require('@site/static/json/lotties/itg-dashboard-4.json');
export const Lottie_Work = require('@site/static/json/lotties/lottiefiles-work.json');
export const Lottie_Work_2 = require('@site/static/json/lotties/lottiefiles-work-2.json');
export const Lottie_China_2 = require('@site/static/json/lotties/lottiefiles-China-2.json');
...
export const Lottie_Man = require('@site/static/json/lotties/itg-man.json');
export const Lottie_Man_2 = require('@site/static/json/lotties/itg-man-2.json');
